...
def distance(city_a, city_b):
    ...
    5.0
    """
    dis = sqrt((city_a[1]-city_b[1])**2+(city_a[2]-city_b[2])**2)
    return dis
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    dis1=(city_a[1]-lat)**2+(city_a[2]-lon)**2
    dis2=(city_b[1]-lat)**2+(city_b[2]-lon)**2
    if dis1>=dis2:return city_b[0]
    else:return city_a[0]
