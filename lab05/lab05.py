...
def add_trees(t1, t2):
    ...
    if t1 == [] or t2 == []:
        ...
        index = 0
        merge_tree = []
        branches_one, branches_two = branches(t1), branches(t2)
        while index < min(len(branches_one), len(branches_two)):
            b1, b2 = branches_one[index], branches_two[index]
            merge_tree += [add_trees(b1, b2)]
            index += 1
        merge_tree += branches_one[index:]
        merge_tree += branches_two[index:]
